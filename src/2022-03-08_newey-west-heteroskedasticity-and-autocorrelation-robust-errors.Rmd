...
```{r}
data_with_white_noise_error <- function(iterations = 10, 
                                        n = 50){
  # Create a dataframe of simulated X and Y data, for a given sample sizes.
  # Each iteration is a single sample for the given parameters.  
